...
var app = (function () {
    ...
    const getdata = () => {
        console.log('url', "http://www.dashcatsoftware.com");
        return fetch("http://www.dashcatsoftware.com", {
            method: 'GET'
        })
    };
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			p = element("p");
    			p.textContent = "I'm ok dad";
    			add_location(p, file$1, 5, 4, 34);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1gyjh8k");
    			add_location(h1, file, 25, 2, 462);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			append_dev(h1, t0);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Fuck loading";
    			attr_dev(h1, "class", "svelte-1gyjh8k");
    			add_location(h1, file, 23, 2, 429);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			if_block.c();
    			attr_dev(main, "class", "svelte-1gyjh8k");
    			add_location(main, file, 21, 0, 405);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		response = await getdata().then(data => data.json());
    		$$invalidate(0, name = response[1].content);
