...
var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			t = text(/*text*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-1y40g1q");
    			add_location(h1, file$3, 5, 4, 55);
    			attr_dev(section, "class", "svelte-1y40g1q");
    			add_location(section, file$3, 4, 0, 41);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-1jgdm8n");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-mvrpcc");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-gph0d5");
    			add_location(div, file, 89, 1, 1828);
    			attr_dev(main, "class", "svelte-gph0d5");
    			add_location(main, file, 77, 0, 1718);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('quotes' in $$props) quotes = $$props.quotes;
    	...
    	return [quote, container, groupBy, main_binding];
    }

    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { groupBy: 2 });
