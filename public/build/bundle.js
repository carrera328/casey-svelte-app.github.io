    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			h1 = element("h1");
    			t = text(/*text*/ ctx[0]);
    			attr_dev(h1, "class", "svelte-xsth2q");
    			add_location(h1, file$3, 5, 4, 55);
    			attr_dev(section, "class", "svelte-xsth2q");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "svelte-1xjp77m");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-lnaazf");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-1tp38db");
    			add_location(div, file, 88, 1, 1827);
    			attr_dev(main, "class", "svelte-1tp38db");
    			add_location(main, file, 76, 0, 1717);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
