...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 5, 4, 48);
    			add_location(h1, file$1, 4, 0, 39);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-bx7thk");
    			add_location(h1, file, 16, 1, 314);
    			attr_dev(main, "class", "svelte-bx7thk");
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(h1, t2);
    			append_dev(main, t3);
    			mount_component(quote, main, null);
    			current = true;
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, name, help, Quote, response });
